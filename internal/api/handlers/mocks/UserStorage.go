...
import (
	...
	models "github.com/rshelekhov/reframed/internal/models"
...
func (_c *UserStorage_CreateUser_Call) Run(run func(ctx context.Context, user models.User)) *UserStorage_CreateUser_Call {
...
func (_c *UserStorage_CreateUser_Call) RunAndReturn(run func(context.Context, models.User) error) *UserStorage_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *UserStorage) GetUserByID(ctx context.Context, id string) (models.User, error) {
	ret := _m.Called(ctx, id)
...
func (_c *UserStorage_GetUserByID_Call) Return(_a0 models.User, _a1 error) *UserStorage_GetUserByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserStorage_GetUserByID_Call) RunAndReturn(run func(context.Context, string) (models.User, error)) *UserStorage_GetUserByID_Call {
	_c.Call.Return(run)
	return _c
}

// GetUsers provides a mock function with given fields: ctx, pgn
func (_m *UserStorage) GetUsers(ctx context.Context, pgn models.Pagination) ([]models.User, error) {
	...
	var r0 []models.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.Pagination) ([]models.User, error)); ok {
		return rf(ctx, pgn)
	}
	if rf, ok := ret.Get(0).(func(context.Context, models.Pagination) []models.User); ok {
		r0 = rf(ctx, pgn)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.User)
...
func (_c *UserStorage_GetUsers_Call) Run(run func(ctx context.Context, pgn models.Pagination)) *UserStorage_GetUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *UserStorage_GetUsers_Call) Return(_a0 []models.User, _a1 error) *UserStorage_GetUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserStorage_GetUsers_Call) RunAndReturn(run func(context.Context, models.Pagination) ([]models.User, error)) *UserStorage_GetUsers_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *UserStorage_UpdateUser_Call) Run(run func(ctx context.Context, user models.User)) *UserStorage_UpdateUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(models.User))
	})
	return _c
...
func (_c *UserStorage_UpdateUser_Call) RunAndReturn(run func(context.Context, models.User) error) *UserStorage_UpdateUser_Call {
	_c.Call.Return(run)
	return _c
}
